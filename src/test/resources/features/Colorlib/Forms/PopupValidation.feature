 ...
 Cada campo del formulario realiza validaciones.
  ...
  Scenario: Diligenciamiento exitoso del formulario
   no se presenta ningun mensaje de valdación
    ...
    |Required|Select|Select2|Select2|Url|Email|Pass|ConfirmPass|Min       |Max|Number|Ip|Dato|DatoTarde|
  ...
  Scenario: Diligenciamiento exitoso del formulario
   no se presenta ningun mensaje de valdación
    ...
    When Diligencio formulario Popup Validation
    |Required|Select|Select2|Select2|Url|Email|Pass|ConfirmPass|Min       |Max|Number|Ip|Dato|DatoTarde|
    | |Golf|Tennis|Golf|http://www.valor1.com|Valor1@gmail.com|valor1|valor1|123456|123456|-99.99|200.200.5.4|2018-08-29|2012/09/12|
    | Valor1|Choose a sport|Tennis|Golf|http://www.valor1.com|Valor1@gmail.com|valor1|valor1|123456|123456|-99.99|200.200.5.4|2018-08-29|2012/09/12|
